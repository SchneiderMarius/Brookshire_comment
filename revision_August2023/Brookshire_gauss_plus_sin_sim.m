...
cfgAll = {}; 
cnt = 0; 
decaypars = [0.02 0.2];%[0.02 0.05 0.1 0.2]%[0.02 0.05 0.1 0.2];
reps = [20 100 500 1000 2000];
nIter = 10;
sinmod = [0 0.02];%[0 0.01 0.02 0.04]; 
sinfreq = 4; %[4 8];
nMed = 1;%
for iRep = reps
...
save('/mnt/pns/departmentN4/MartinCode/CodeBrookshire/Brookshire_code_final/gauss_and_sin_1','out', 'cfgAll')
%% 